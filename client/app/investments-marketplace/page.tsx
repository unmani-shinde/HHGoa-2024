...
export function InvestmentsMarketplace() {
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4">
          {estates?.map((estate, index) => {
            ...
            if (estateResult.estateOwner !== address && estateResult.isListedForInvestment) {
              return (
                <CardComponent isInvestmentMarketplace={true} ismyInvestmentTokens={false} ismyAuctionTokens={false} isauctionMarketplace={false} key={index} estate={estateResult} />
              );
            }
