...
export default function NavigationBar() {
  ...
  return (
    <div className="bg-white">
      <header className="bg-red-50 dark:bg-red-900 absolute inset-x-0 top-0 z-50">
        ...
        <Dialog open={mobileMenuOpen} onClose={setMobileMenuOpen} className="lg:hidden">
          ...
          <DialogPanel className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-red-50 dark:bg-red-900  px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
